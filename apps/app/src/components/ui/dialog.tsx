    ...
    <DialogPortal>
      ...
      <DialogViewport>
        <DialogPrimitive.Popup
          ...
          className={cn(
            "bg-background shadow-popup-border ease-out-expo fixed left-1/2 grid max-h-[calc(100%-2rem)] w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-[30%] gap-4 rounded-xl p-4 text-sm transition-all duration-450 outline-none sm:max-w-sm",
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "bg-muted/50 border-t-border -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
