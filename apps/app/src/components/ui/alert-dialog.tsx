    ...
    <AlertDialogPortal>
      ...
      <AlertDialogViewport>
        <AlertDialogPrimitive.Popup
          ...
          data-size={size}
          className={cn(
            "bg-background ring-foreground/10 group/alert-dialog-content fixed top-1/2 left-1/2 grid w-full -translate-x-1/2 -translate-y-[30%] gap-4 rounded-xl p-4 ring-1 transition-all duration-150 ease-out outline-none data-[size=default]:max-w-sm data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-md",
