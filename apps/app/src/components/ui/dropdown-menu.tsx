    ...
    <DropdownMenuPortal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground shadow-border-md yawa ease-out-expo max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg p-1 duration-300 outline-none data-closed:overflow-hidden data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0",
            className
          )}
          {...props}
        />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        "bg-popover text-popover-foreground shadow-border-md w-auto min-w-24 rounded-lg p-1 transition-none",
        className
      )}
      align={align}
      alignOffset={alignOffset}
