    ...
    <PopoverMenuPortal>
      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground shadow-border-md ease-out-expo text-xs-plus flex max-h-(--available-height) w-75 min-w-32 origin-(--transform-origin) flex-col gap-2.5 rounded-lg outline-hidden duration-300 data-closed:overflow-hidden data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0",
